...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		leftArrow = new FlxSprite(600, 670);
		leftArrow.frames = ui_tex;
		leftArrow.animation.addByPrefix('idle', "arrow down");
		leftArrow.animation.addByPrefix('press', "arrow push down");
		...
		rightArrow = new FlxSprite(leftArrow.x + 0, leftArrow.y + -110);
		rightArrow.frames = ui_tex;
		rightArrow.animation.addByPrefix('idle', 'arrow up');
		rightArrow.animation.addByPrefix('press', "arrow push up", 24, false);
